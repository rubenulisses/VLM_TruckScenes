...
# MAGIC %pip install --upgrade transformers==4.39.0 mlflow>=2.11.3 tensorflow==2.16.1
...
# MAGIC %pip install -r /tmp/my_model_dir/requirements.txt
...
# MAGIC %sh
# MAGIC # Remove incomplete unzipped files, if any
# MAGIC rm -rf /tmp/full_dataset_unzipped
# MAGIC rm -rf /tmp/full_dataset_final
# MAGIC
# MAGIC # Re-concatenate to make sure no corrupt bytes are included
# MAGIC cat /tmp/full_dataset/ezyZip.z* > /tmp/full_dataset/ezyZip_complete.zip
# MAGIC
# MAGIC # Attempt extraction
# MAGIC unzip -FF /tmp/full_dataset/ezyZip_complete.zip -d /tmp/full_dataset_unzipped
# MAGIC
# MAGIC cd /tmp/full_dataset_unzipped
# MAGIC unzip full_dataset.zip -d /tmp/full_dataset_final

# COMMAND ----------

# MAGIC %md
# MAGIC # Install Truckscenes
...
# MAGIC from truckscenes import TruckScenes
# MAGIC
# MAGIC # Edit the path to the mini / full dataset
# MAGIC path_to_folder = "/tmp/full_dataset_final/"
# MAGIC trucksc = TruckScenes('v0.1-trainval_LFMC', path_to_folder, True)

# COMMAND ----------

# MAGIC %md
# MAGIC # Evaluation of the Model

# COMMAND ----------

# MAGIC %md
# MAGIC ### Get all scenes images
...
# MAGIC %md
# MAGIC ### Save differences to DBFS
